...
function formBasic() {
    ...
    basic.BlockMoulds["input"] = new BlockMould("input", { "English": "input", "Chinese": "输入" }, "data", "input", "sys_lib_basic", { width: 2, height: 1 }, 0, 0, 0, 1, (innerInput, preDataStream, variableTables) => {
...
function formMath() {
    ...
    math.BlockMoulds["abs"] = new BlockMould("abs", { "English": "abs", "Chinese": "绝对值" }, "data", "abs", "sys_lib_math", { width: 2, height: 2 }, 0, 0, 1, 1, (innerInput, preDataStream, variableTables) => {
        let ds1 = preDataStream[0].readData(variableTables);
        if (ds1.type == "number")
            return { logicport: -1, dataOutput: [new DataStream(ds1.type, Math.abs(ds1.data))] };
    });
    math.BlockMoulds["sqrt"] = new BlockMould("sqrt", { "English": "sqrt", "Chinese": "开根" }, "data", "sqrt", "sys_lib_math", { width: 2, height: 2 }, 0, 0, 1, 1, (innerInput, preDataStream, variableTables) => {
        let ds1 = preDataStream[0].readData(variableTables);
        if (ds1.type == "number")
            return { logicport: -1, dataOutput: [new DataStream(ds1.type, Math.sqrt(ds1.data))] };
    });
    math.BlockMoulds["constant_e"] = new BlockMould("constant_e", { "English": "constant e", "Chinese": "常数e" }, "data", "constant_e", "sys_lib_math", { width: 2, height: 2 }, 0, 0, 0, 1, (innerInput, preDataStream, variableTables) => {
        return { logicport: -1, dataOutput: [new DataStream("number", Math.E)] };
    });
    math.BlockMoulds["exp"] = new BlockMould("exp", { "English": "exp", "Chinese": "exp" }, "data", "exp", "sys_lib_math", { width: 2, height: 2 }, 0, 0, 1, 1, (innerInput, preDataStream, variableTables) => {
        let ds1 = preDataStream[0].readData(variableTables);
        if (ds1.type == "number")
    ...
    math.BlockMoulds["ln"] = new BlockMould("ln", { "English": "ln", "Chinese": "ln" }, "data", "ln", "sys_lib_math", { width: 2, height: 2 }, 0, 0, 1, 1, (innerInput, preDataStream, variableTables) => {
        let ds1 = preDataStream[0].readData(variableTables);
        if (ds1.type == "number")
    ...
    math.BlockMoulds["constant_pi"] = new BlockMould("constant_pi", { "English": "constant π", "Chinese": "常数π" }, "data", "constant_pi", "sys_lib_math", { width: 2, height: 2 }, 0, 0, 0, 1, (innerInput, preDataStream, variableTables) => {
        return { logicport: -1, dataOutput: [new DataStream("number", Math.PI)] };
    });
    math.BlockMoulds["sin"] = new BlockMould("sin", { "English": "sin", "Chinese": "sin" }, "data", "sin", "sys_lib_math", { width: 2, height: 2 }, 0, 0, 1, 1, (innerInput, preDataStream, variableTables) => {
        let ds1 = preDataStream[0].readData(variableTables);
        if (ds1.type == "number")
            return { logicport: -1, dataOutput: [new DataStream(ds1.type, Math.sin(ds1.data))] };
    });
    math.BlockMoulds["cos"] = new BlockMould("cos", { "English": "cos", "Chinese": "cos" }, "data", "cos", "sys_lib_math", { width: 2, height: 2 }, 0, 0, 1, 1, (innerInput, preDataStream, variableTables) => {
        let ds1 = preDataStream[0].readData(variableTables);
        if (ds1.type == "number")
            return { logicport: -1, dataOutput: [new DataStream(ds1.type, Math.cos(ds1.data))] };
    });
    math.BlockMoulds["tan"] = new BlockMould("tan", { "English": "tan", "Chinese": "tan" }, "data", "tan", "sys_lib_math", { width: 2, height: 2 }, 0, 0, 1, 1, (innerInput, preDataStream, variableTables) => {
        let ds1 = preDataStream[0].readData(variableTables);
        if (ds1.type == "number")
            return { logicport: -1, dataOutput: [new DataStream(ds1.type, Math.tan(ds1.data))] };
    });
    math.BlockMoulds["asin"] = new BlockMould("asin", { "English": "asin", "Chinese": "asin" }, "data", "asin", "sys_lib_math", { width: 2, height: 2 }, 0, 0, 1, 1, (innerInput, preDataStream, variableTables) => {
        let ds1 = preDataStream[0].readData(variableTables);
        return { logicport: -1, dataOutput: [new DataStream(ds1.type, Math.asin(ds1.data))] };
    });
    math.BlockMoulds["acos"] = new BlockMould("acos", { "English": "acos", "Chinese": "acos" }, "data", "acos", "sys_lib_math", { width: 2, height: 2 }, 0, 0, 1, 1, (innerInput, preDataStream, variableTables) => {
        let ds1 = preDataStream[0].readData(variableTables);
        if (ds1.type == "number")
            return { logicport: -1, dataOutput: [new DataStream(ds1.type, Math.acos(ds1.data))] };
    });
    math.BlockMoulds["atan"] = new BlockMould("atan", { "English": "atan", "Chinese": "atan" }, "data", "atan", "sys_lib_math", { width: 2, height: 2 }, 0, 0, 1, 1, (innerInput, preDataStream, variableTables) => {
        let ds1 = preDataStream[0].readData(variableTables);
        if (ds1.type == "number")
